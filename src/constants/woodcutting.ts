import type { Trees, StoreTrees } from '@/types/woodcutting'

export const TREES: Trees = new Map([
  [
    'tree1',
    {
      name: 'Normal Tree',
...
export const MAX_POOL_EXP = TREES.size * 500_000

export const STORE_TREES: StoreTrees = new Map([
  ['tree1', { masteryXP: 0 }],
  ['tree2', { masteryXP: 0 }],
  ['tree3', { masteryXP: 0 }],
  ['tree4', { masteryXP: 0 }],
